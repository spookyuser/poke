---
name: poke-ordering
description: CLI for browsing menus and placing orders at The Poke Co (South Africa). Use when users want to buy or order something from poke co.
allowed-tools: Bash(node scripts/poke-cli.js:*)
---
